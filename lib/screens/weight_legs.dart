...
class LegsWeights extends StatefulWidget {
  //const ArmsWeights({ Key? key }) : super(key: key);

  @override
  _LegsWeightsState createState() => _LegsWeightsState();
}

class _LegsWeightsState extends State<LegsWeights> {
  @override
